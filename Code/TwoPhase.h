...
struct TwoPhase
{
	...
	bool Solve(double timeLimit, double* TwoPhase_Iter, double* TwoPhase_Cut, double* TwoPhase_CPU, double* TwoPhase_Obj, double* SP_Cons_CPU, double* SP_Solve_CPU, double* MP_CPU);
